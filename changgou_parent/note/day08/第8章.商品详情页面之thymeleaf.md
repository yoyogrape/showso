...
```java
@Controller
@RequestMapping(cocom.changgou.common.testanggou.common.test)
...
```
http://com.changgou.common.testlhost:8080/test/hello
```
...
```html
<formcom.changgou.common.testaction="@{/test/hello}" >
