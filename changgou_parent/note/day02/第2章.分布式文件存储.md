...
![1559117994668](image\Snipaste_2020-06-07_23-00-19.png)
...
location /group1/M00 {
 ...
 location ~ /M00 {
     add_header Cache-control no-store;//清楚浏览器缓存
...
​	①/data/nginx/conf/nginx.conf 配置nginx的参数

​	配置端口，存储文件路径（/data/fast_data/data），网页过滤，错误返回，

​	②/etc/fdfs/storage.conf和/etc/fdfs/tracker.conf

​	配置storage和tracker的参数

​	③文件存储目录/data/fast_data/data/00/00
...
"http://192.168.200.128:8080/group1/M00/00/00/wKjIgF7fjECEHtyLAAAAAJhcs8Y51..png" 
